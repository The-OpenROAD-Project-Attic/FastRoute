...
#line 131 "liberty_parser.y" /* yacc.c:1646  */
                {
                        (yyval.head) = (liberty_head *)my_calloc(sizeof(liberty_head), 1);
...
#line 166 "liberty_parser.y" /* yacc.c:1646  */
                {
                        curr_def = si2drGroupCreateDefine(gs[gsindex - 1], (yyvsp[-6].str), (yyvsp[-4].str), convert_vt((yyvsp[-2].str)), &err);
                        si2drObjectSetLineNo(curr_def, lineno, &err);
                        si2drObjectSetFileName(curr_def, curr_file, &err);
                        if (token_comment_buf[0]) {
                                si2drDefineSetComment(curr_def, token_comment_buf, &err);
...
#line 175 "liberty_parser.y" /* yacc.c:1646  */
                {
                        curr_def = si2drGroupCreateDefine(gs[gsindex - 1], (yyvsp[-4].str), (yyvsp[-2].str), SI2DR_UNDEFINED_VALUETYPE, &err);
                        si2drObjectSetLineNo(curr_def, lineno, &err);
                        si2drObjectSetFileName(curr_def, curr_file, &err);
                        if (token_comment_buf[0]) {
                                si2drDefineSetComment(curr_def, token_comment_buf, &err);
...
#line 253 "liberty_parser.y" /* yacc.c:1646  */
                {
                        ...
                        if ((yyvsp[0].expr)->type == SI2DR_EXPR_VAL && (yyvsp[0].expr)->valuetype == SI2DR_FLOAT64 && !(yyvsp[0].expr)->left && !(yyvsp[0].expr)->right) {
                                ...
                                /* printf("EXPR->int - %d \n", $1->u.i); */
                                si2drExprDestroy((yyvsp[0].expr), &err);
                        } else if ((yyvsp[0].expr)->type == SI2DR_EXPR_OP_SUB && (yyvsp[0].expr)->left && !(yyvsp[0].expr)->right && (yyvsp[0].expr)->left->valuetype == SI2DR_FLOAT64 && !(yyvsp[0].expr)->left->left && !(yyvsp[0].expr)->left->right) {
                                (yyval.val) = (liberty_attribute_value *)my_calloc(sizeof(liberty_attribute_value), 1);
                                (yyval.val)->type = LIBERTY__VAL_DOUBLE;
                                (yyval.val)->u.double_val = -(yyvsp[0].expr)->left->u.d;
                                /* printf("EXPR->double - %g \n", $1->u.d); */
                                si2drExprDestroy((yyvsp[0].expr), &err);
                        } else if ((yyvsp[0].expr)->type == SI2DR_EXPR_OP_SUB && (yyvsp[0].expr)->left && !(yyvsp[0].expr)->right && (yyvsp[0].expr)->left->valuetype == SI2DR_INT32 && !(yyvsp[0].expr)->left->left && !(yyvsp[0].expr)->left->right) {
                                (yyval.val) = (liberty_attribute_value *)my_calloc(sizeof(liberty_attribute_value), 1);
                                (yyval.val)->type = LIBERTY__VAL_INT;
                                (yyval.val)->u.int_val = -(yyvsp[0].expr)->left->u.i;
                                /* printf("EXPR->double - %g \n", $1->u.d); */
                                si2drExprDestroy((yyvsp[0].expr), &err);
                        } else if ((yyvsp[0].expr)->type == SI2DR_EXPR_OP_ADD && (yyvsp[0].expr)->left && !(yyvsp[0].expr)->right && (yyvsp[0].expr)->left->valuetype == SI2DR_FLOAT64 && !(yyvsp[0].expr)->left->left && !(yyvsp[0].expr)->left->right) {
                                (yyval.val) = (liberty_attribute_value *)my_calloc(sizeof(liberty_attribute_value), 1);
                                (yyval.val)->type = LIBERTY__VAL_DOUBLE;
                                (yyval.val)->u.double_val = (yyvsp[0].expr)->left->u.d;
                                /* printf("EXPR->double + %g \n", $1->u.d); */
                                si2drExprDestroy((yyvsp[0].expr), &err);
                        } else if ((yyvsp[0].expr)->type == SI2DR_EXPR_OP_ADD && (yyvsp[0].expr)->left && !(yyvsp[0].expr)->right && (yyvsp[0].expr)->left->valuetype == SI2DR_INT32 && !(yyvsp[0].expr)->left->left && !(yyvsp[0].expr)->left->right) {
                                (yyval.val) = (liberty_attribute_value *)my_calloc(sizeof(liberty_attribute_value), 1);
                                (yyval.val)->type = LIBERTY__VAL_INT;
                                (yyval.val)->u.int_val = (yyvsp[0].expr)->left->u.i;
                                /* printf("EXPR->double + %g \n", $1->u.d); */
